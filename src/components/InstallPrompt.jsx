      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] overflow-y-auto bg-black/60 backdrop-blur-sm">
          <div className="flex min-h-full items-start justify-center p-4 sm:items-center sm:p-6">
            <div className="relative mt-4 w-full max-w-sm rounded-[32px] bg-white shadow-2xl animate-in slide-in-from-bottom-10 duration-300 dark:bg-ios-surface sm:mt-0 sm:zoom-in">
              <button onClick={() => setIsOpen(false)} className="absolute right-5 top-5 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-gray-100/80 text-gray-500 transition-colors hover:bg-gray-200 dark:bg-ios-surface-2 dark:text-ios-secondary dark:hover:bg-ios-surface-2">
                <X size={18} />
              </button>
              <div className="max-h-[calc(100dvh-2rem)] overflow-y-auto p-6">
                ...
                <div className="space-y-4 pb-2">
                  ...
                  <button 
                    ...
                    className="w-full bg-black hover:bg-gray-900 text-white font-bold py-4 rounded-2xl mt-6 active:scale-95 transition-all text-[15px] shadow-lg"
                  >
                    我知道了，馬上去安裝！
                  </button>
                </div>
