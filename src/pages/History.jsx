...
export default function History({ navigate }) {
  ...
  return (
    <div className="flex flex-col h-full bg-gray-50 dark:bg-gray-950 relative">
      <div className="flex items-center p-4 bg-white dark:bg-gray-950 border-b border-gray-100 dark:border-gray-800 shrink-0 sticky top-0 z-10">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        {loading ? (
          ...
          orders.map(order => (
            <div key={order.id} className="bg-white dark:bg-gray-900 rounded-2xl p-4 shadow-sm border border-gray-100 dark:border-gray-800">
              ...
              <div className="space-y-2 mb-2">
                <div className="flex font-medium text-sm text-gray-900 dark:text-white border-b border-gray-50 dark:border-gray-800 pb-2">
                ...
                <div className="flex font-medium text-sm text-gray-900 dark:text-white">
                  ...
                  <span className="whitespace-pre-line flex-1 text-gray-700 dark:text-gray-300 leading-[1.6] text-[13px]">{order.items}</span>
                </div>
              </div>
            </div>
          ))
